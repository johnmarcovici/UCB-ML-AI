...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Say Hello to Your Fellow Cohort-Members",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    parser.add_argument(
        "--message-file",
        type=str,
        default="./messages/factory_hello.json",
        help="Message File - a JSON-formatted file with keys name, message, and sign_off",
    )
    ...
    assert all(
        key in message_dict for key in required_keys
